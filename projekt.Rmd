...
Der p-Wert gibt an, wie wahrscheinlich es ist, eine Stichprobe zu ziehen, die $H_1$ zumindest so stark wie unsere unterstützt, sofern die Nullhypothese gilt. Wenn diese Wahrscheinlichkeit unter $\alpha$ liegt, wird die Nullhypothese abgelehnt.  
